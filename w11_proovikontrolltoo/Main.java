...
public class Main {
    public static void main(String[] args) {
        List<String> strings = Arrays.asList("one", "two", "threee");
        ...
        System.out.println(Generics.getFirst(strings) + " " +
        ...
        SimplePair<Integer, String> pair = new SimplePair<Integer,String>(5, "Anna");
